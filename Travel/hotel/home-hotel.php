...
<body>
	...
	<div id="wrap">
						...
						<div class="tb">
							<div class="tb-cell">
								<ul class="menu-list text-uppercase">
									...
									<ul class="sub-menu">
											<li class="current-menu-item"><a href="home-hotel.html"
												title="">Hotel</a></li>
		...
		<?php include '../includes/indexpagesection.php';?>
		<section class="sales">
			<div class="title-wrap">
				<div class="container">
					...
					<a href="#" title=""
						class="awe-btn awe-btn-5 awe-btn-lager arrow-right text-uppercase float-right">ALL
						SALES</a>
				</div>
			</div>
			<div class="container">
				<div class="sales-cn">
					<div class="row">
						<div class="col-xs-6 col-md-3">
							<div class="sales-item">
								<figure class="home-sales-img">
									<a href="" title=""><img src="../images/deal/img-1.jpg" alt=""></a>
									<figcaption>
										Save <span>30</span>%
									</figcaption>
								</figure>
						...
						<div class="col-xs-6 col-md-3">
							<div class="sales-item">
								<figure class="home-sales-img">
									<a href="" title=""><img src="../images/deal/img-2.jpg" alt=""></a>
									<figcaption>
										Save <span>30</span>%
									</figcaption>
								</figure>
						...
						<div class="col-md-6">
							<div class="sales-item">
								<figure class="home-sales-img">
									<a href="" title=""><img src="../images/deal/img-3.jpg" alt=""></a>
									<figcaption>
										Save <span>30</span>%
									</figcaption>
								</figure>
						...
						<div class="col-md-6">
							<div class="sales-item">
								<figure class="home-sales-img">
									<a href="" title=""><img src="../images/deal/img-4.jpg" alt=""></a>
									<figcaption>
										Save <span>30</span>%
									</figcaption>
								</figure>
						...
						<div class="col-xs-6 col-md-3">
							<div class="sales-item">
								<figure class="home-sales-img">
									<a href="" title=""><img src="../images/deal/img-5.jpg" alt=""></a>
									<figcaption>
										Save <span>30</span>%
									</figcaption>
								</figure>
						...
						<div class="col-xs-6 col-md-3">
							<div class="sales-item">
								<figure class="home-sales-img">
									<a href="" title=""><img src="../images/deal/img-6.jpg" alt=""></a>
									<figcaption>
										Save <span>30</span>%
									</figcaption>
								</figure>
										...
										<div class="magazine-footer clearfix">
											<div class="post-share magazine-share float-left">
												<a href="" title=""><i class="fa fa-facebook"></i></a> <a
													href="" title=""><i class="fa fa-twitter"></i></a> <a
													href="" title=""><i class="fa fa-google-plus"></i></a>
											</div>
											<a href="" title=""
												class="awe-btn awe-btn-5 arrow-right awe-btn-lager text-uppercase float-right">view
												more</a>
						...
						<div class="confidence">
							...
							<ul>
								...
								<h5>No booking charges</h5>
									<p>We don't charge you an extra fee for booking a hotel room
										with us</p></li>
								<li><span class="label-nb">02</span>
								<h5>No cancellation fees</h5>
									<p>We don't charge you a cancellation or modification fee in
										case plans change</p></li>
								<li><span class="label-nb">03</span>
								<h5>Instant confirmation</h5>
									<p>Instant booking confirmation whether booking online or via
										the telephone</p></li>
								<li><span class="label-nb">04</span>
								<h5>Flexible booking</h5>
									<p>You can book up to a whole year in advance until the moment
										of your stay</p></li>
							</ul>
						</div>
					</div>
						...
						<div class="subscribe">
							...
							<div class="subscribe-form">
								<form action="#" method="get">
									...
									<button type="submit"
										class="awe-btn awe-btn-5 arrow-right text-uppercase awe-btn-lager">subcrible</button>
								</form>
							</div>
							<div class="follow-us">
								<h4>Follow us</h4>
								<div class="follow-group">
									...
									<a href="" title=""><i class="fa fa-twitter"></i></a> <a href=""
										...
										title=""><i class="fa fa-google-plus"></i></a> <a href=""
										title=""><i class="fa fa-digg"></i></a>
								</div>
							</div>
						</div>
					</div>
